...
interface SchoolDao {
    ...
    suspend fun getListOfStudents(): List<String>

    @Transaction
    @Query("SELECT subjectName FROM studentsubjectcrossref WHERE studentName =:studentName")
    suspend fun getListOfSubjectByStudent(studentName: String): List<String>

    @Transaction
    @Query("SELECT subjectName FROM subject")
    suspend fun getListOfSubjects(): List<String>

    @Transaction
    @Query("SELECT studentName FROM studentsubjectcrossref WHERE subjectName =:subjectName")
    suspend fun getListOfStudentsBySubject(subjectName: String): List<String>
