package ru.samsung.itschool.myapplication.ui
...
class BlankFragment6 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val textView: TextView = view.findViewById(R.id.textView228)
        val btn: Button = view.findViewById(R.id.ButtonBack1)
        btn.setOnClickListener {
            findNavController().popBackStack()
        }
        (this.id.toString()+"\nFRAGMENT 6").also { textView.text = it }
    }
